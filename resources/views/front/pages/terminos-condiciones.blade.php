...
<head>
  ...
  <title>Términos y Condiciones — Corral X</title>
...
<body>
  ...
  <main>
    <div class="container">
      ...
      <p class="date"><strong>Última actualización:</strong> 19 de noviembre de 2025</p>
      ...
      <p>El manejo de tus datos personales se rige por nuestra Política de Privacidad. Al utilizar nuestros servicios, aceptas la recopilación y uso de información según se describe en dicha política.</p>
      ...
      <h2>13. Contacto</h2>
      <p>Para consultas sobre estos términos, puedes contactarnos a través de los canales de soporte disponibles en la plataforma o escribiendo a <strong>soporte@corralx.com</strong>.</p>
    </div>
  </main>
