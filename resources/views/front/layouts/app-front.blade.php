...
<head>
    ...
    <title>Corral X - El Marketplace Ganadero de Venezuela</title>
    ...
    <meta property="og:image" content="{{ asset('assets/front/images/LOGO_CORRAL.png') }}">
    ...
    <meta name="twitter:image" content="{{ asset('assets/front/images/LOGO_CORRAL.png') }}">
