<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    },
    {
      ...
      "screenshot": "{{ asset('assets/front/images/images/phone-mockup.jpg') }}"
    },
    {
      "@type": "FAQPage",
      "mainEntity": [
    ...
    },
    {
      "@type": "Service",
      "@id": "{{ url('/') }}#service",
      "serviceType": "Marketplace Ganadero",
      "provider": {"@id": "{{ url('/') }}#organization"},
      "areaServed": {"@type": "Country", "name": "Venezuela"},
      "description": "Plataforma digital para comprar y vender ganado bovino, bufalino, equino y porcino. También incluye equipos de hacienda, maquinaria agrícola, insumos ganaderos y servicios de transporte.",
      "hasOfferCatalog": {
        "@type": "OfferCatalog",
