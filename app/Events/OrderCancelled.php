...
/**
 * Evento de pedido cancelado para broadcasting en tiempo real
 * Se dispara cuando un pedido es cancelado (por comprador o vendedor)
 */
class OrderCancelled implements ShouldBroadcast
{
    ...
    public function __construct(Order $order)
    {
        ...
        \Log::info('🔊 OrderCancelled event creado', [
            'order_id' => $order->id,
